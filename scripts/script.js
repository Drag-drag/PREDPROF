...
length_of_way = document.getElementsByClassName('length_of_way');
time_of_way = document.getElementsByClassName('time_of_way');
...
function init() {
    ...
    multiRoute.model.events.add('requestsuccess', function () {
        ...
        length_of_way.textContent = `Длина пути: ${activeRoute.properties.get("distance").text}`;
        time_of_way.textContent = `Время: ${activeRoute.properties.get("duration").text}`;
